...
//        this.layout = new ClientTriple()
        this.layout = new ClientTriple([this.editor.el])
//        this.layout.first.children = [this.editor.el]
        this.layout.menu.children = [this.menu.el]
        this.layout.last.children = [this.viewer.el]
//        this.layout.first.children = [()=>this.editor.el]
//        this.layout.menu.children = [()=>this.menu.el]
//        this.layout.last.children = [()=>this.viewer.el]
        this.#init()
...
//        console.log('Read :', count.read)
        this.counter.Word.countup()
        console.log('Write:', this.counter.Word.Write)
        console.log('Print:', this.counter.Word.Print)
        console.log('Read:', this.counter.Word.Read)
    }
}
class MenuScreen {
    constructor(items) {
