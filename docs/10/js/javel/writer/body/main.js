...
class JavelBodyWriter {
    constructor() {
        ...
        */
        this._anyoneBtn = new AnyOneButton(this.exporter, this.manuscript)
        this.menu = new MenuScreen([
            headBtn,
...
class AnyOneButton { // ButtonSelector 常にどれか一つのボタンだけ表示する
    constructor(exporter, manuscript) {
        ...
        this._expBtn = DivButton.make(()=>{this._exporter.export(this._manuscript.val);this.showAbout();this._expBtn.focus();}, ()=>`出`)
