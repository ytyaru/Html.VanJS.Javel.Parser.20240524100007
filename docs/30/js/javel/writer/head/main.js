...
class HeadViewer extends Viewer {
    constructor(data, ja) {
        ...
        this._data = data
        this._ja = ja
        this._title = van.derive(()=>van.tags.div(Parser.Javel.toBlockElements(this._data.title.val)))
        this._catch = van.derive(()=>van.tags.div(Parser.Javel.toBlockElements(this._data.catch.val)))
