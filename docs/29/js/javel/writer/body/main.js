...
――そのとき、神風が吹いた`
    ...
    resize() { this.layout.resize(); this.menu.resize(); }
}
class MenuScreen {
    constructor(items) {
...
class Viewer {
    ...
    #style() { return `${this.#writingMode()}${this.#break()}${this.#overflow()}` }
    #writingMode() { return `writing-mode:${this._writingMode.val};text-orientation:${this._textOrient.val};` }
    #break() { return `word-break:break-all;overflow-wrap:anywhere;hyphens:auto;` }
    #overflow() { return `overflow:auto;` }
    #onWheel(e) {
